...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 204.0, 198.0, 113.0, 22.0 ],
					"presentation_rect" : [ 203.0, 197.0, 0.0, 0.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 108.0, 198.0, 87.0, 22.0 ],
					"style" : "",
					"text" : "prepend cutoff"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 198.0, 83.0, 22.0 ],
					"style" : "",
					"text" : "osc2_tune $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 113.0, 157.0, 89.0, 22.0 ],
					"style" : "",
					"text" : "unpack 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 239.0, 157.0, 257.0, 22.0 ],
					"style" : "",
					"text" : "-201. 14237.71582 0.980069"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 113.0, 120.0, 109.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 204.0, 96.0, 285.0, 22.0 ],
					"style" : "",
					"text" : "/wek/outputs -201. 14237.71582 0.980069"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 931.0, 306.0, 150.0, 48.0 ],
					"style" : "",
					"text" : "osc2_tune -1000 1000\ncutoff 10 20000\nfilter_resonance 0 1"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 51.75, 253.309662, 106.0, 36.0 ],
									"style" : "",
									"text" : "filter_resonance $1"
								}
...
, 							{
								"box" : 								{
									"id" : "obj-2",
									"items" : [ "Attack", ",", "Decay", ",", "Release", ",", "Sustain", ",", "VelMod", ",", "cutoff", ",", "env_amount", ",", "filter_attack", ",", "filter_decay", ",", "filter_release", ",", "filter_resonance", ",", "filter_sustain", ",", "filter_tracking", ",", "filter_velocity", ",", "level", ",", "osc1_level", ",", "osc1_octave", ",", "osc1_tune", ",", "osc1_wave", ",", "osc2_level", ",", "osc2_octave", ",", "osc2_tune", ",", "osc2_wave", ",", "voices" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
...
,
					"patching_rect" : [ 108.0, 240.0, 83.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 890.0, 89.0, 150.0, 20.0 ],
					"style" : "",
					"text" : "kslider"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 50.0, 163.5, 58.0, 22.0 ],
									"style" : "",
									"text" : "midiflush"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 156.0, 138.5, 24.0, 24.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 156.0, 108.5, 50.5, 22.0 ],
									"style" : "",
									"text" : "keyup"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "" ],
									"patching_rect" : [ 50.0, 129.5, 82.0, 22.0 ],
									"style" : "",
									"text" : "midiformat"
								}
...
,
					"patching_rect" : [ 652.0, 185.5, 91.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 652.0, 65.5, 53.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 652.0, 110.5, 336.0, 53.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 113.0, 65.5, 106.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 108.0, 481.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 108.0, 270.0, 745.0, 196.0 ],
						...
						"snapshot" : 						{
							...
							"valuedictionary" : 							{
								"parameter_values" : 								{
									...
									"env_amount" : 100.0,
									"filter_attack" : 1.0,
									"filter_decay" : 4024.436523,
									"filter_release" : 3671.803711,
									"filter_resonance" : 0.980069,
									"filter_sustain" : 60.189396,
									"filter_tracking" : -48.718109,
									"filter_velocity" : 9.84252,
									"level" : -4.188976,
									"osc1_level" : 100.0,
									"osc1_octave" : 0.748031,
									"osc1_tune" : 0.0,
									"osc1_wave" : 3.0,
									"osc2_level" : 100.0,
									"osc2_octave" : 0.11811,
...
,
									"fileref" : 									{
										...
										"filepos" : -1,
										"snapshotfileid" : "53c8ccb5265ae9121f10f8ebb444522a"
									}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-25", 0 ],
					"midpoints" : [ 843.5, 468.0, 864.0, 468.0, 864.0, 225.0, 117.5, 225.0 ],
					"source" : [ "obj-1", 3 ]
				}
